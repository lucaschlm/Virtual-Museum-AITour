...
class GetInfo : MonoBehaviour {
    ...
    private void LancementRenaissanceQuiz(){
        // TODO à Compléter
        string newcontext = "Le joueur doit passer un quiz à la fin de la salle pour accéder à la prochaine.Voici les questions  que tu dois poser une par une : 1. Which artwork in the Renaissance Hall depicts the scene where Jesus shares his last meal with his apostles? 2. Which artist sculpted Moses? 3. Which sculpture in the Renaissance Hall represents a female mythological figure, symbolizing the sea? 4. Which sculpture in the Renaissance Hall shows a biblical hero facing Goliath? 5. In which artwork in the Renaissance Hall can you see a mysterious smile and a gaze that follows the viewer? Si le joueur à faux à une question, il doit recommencer le quiz au début.Si le joueur à toutes les bonnes réponses, ajoute à la fin de ton message Action: Quiz valide";
